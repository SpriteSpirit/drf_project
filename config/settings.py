...
SECRET_KEY = "django-insecure-#h0m5x0qqtb*(_588glt*e^hf7(!gl2=pco$@69f(vvi!oo-y!"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# настройки для подключения к БД (прописать доступные хосты)
ALLOWED_HOSTS = ['127.1.1.0', 'localhost', '127.0.0.1', '*']  # !!!!!!!!!!!
